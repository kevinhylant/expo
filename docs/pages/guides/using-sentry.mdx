...
Once you have each of these: **organization slug**, **project slug**, **DSN**, and **auth token**, you're all set to proceed.
...
- **organization slug** is available in your **Organization settings** tab
- **project slug** is available in your project's **Settings** > **Projects** tab (find it in the list)
- **`DSN`** is available in your project's **Settings** > **Projects** > **Project name** > **Client Keys
  (DSN)** tab.
...
Once you have each of these: organization slug, project slug, DSN, and auth token, you're all set!
      ...
      "postPublish": [
        {
          ...
          "config": {
            "organization": "sentry org slug, or use the `SENTRY_ORG` environment variable",
            "project": "sentry project slug, or use the `SENTRY_PROJECT` environment variable"
          }
        }
      ]
    }
